...
public class WaitlistDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_WAITINGLIST_TABLE = "CREATE TABLE "
                ...
                + ");";
        db.execSQL(SQL_CREATE_WAITINGLIST_TABLE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // kondisi kalau mau append kolom baru misalnya, seharusnya jangan drop, drop hanya buat gampangnya aja
